...
<div class="alert alert-info">
  <div class="d-flex flex-row align-items-start justify-content-between">
    <div class="flex-grow">
      <p class="m-0">Access to this work is provided through the
...
<p>Information about use can be found in the <a href="//{HT.www_domain}/the-collection/access-use-policy/#ic">HathiTrust Access and Use Policy</a>.</p>
