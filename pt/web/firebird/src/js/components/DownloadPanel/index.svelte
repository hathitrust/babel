<script>
  ...
  function cancelDownload() {
    if ( ! downloadInProgress ) { console.log("-- download.cancelDownload EXITING"); return; }
...
<Panel parent="#controls">
  ...
  <svelte:fragment slot="body">
    ...
    <form>
      ...
      <p class="fs-7 mb-1">
        <a class="fs-7" target="_blank" href="https://hathitrust.atlassian.net/servicedesk/customer/kb/view/2387247137">Download Help</a>
      </p>
      {#if ! manifest.allowFullDownload && ! HT.login_status.logged_in}
      <p class="fs-7 mt-1 mb-1">
        <strong><a href="/cgi/wayf?target={encodeURIComponent(location.href)}">Log in</a></strong> to your library to download this item.
      </p>
      <p class="fs-7 mt-1 fst-italic">
        If you are not affiliated with a <a target="_blank" href="https://www.hathitrust.org/member-libraries/member-list/">member institution</a>, 
        whole book download is not available. 
        (<a targt="_blank" href="https://hathitrust.atlassian.net/servicedesk/customer/kb/view/2387247137">Why not?</a>)
      </p>
      {/if}
    </form>
  ...
  <svelte:fragment slot="body">
    <div xxstyle="width: 30rem">
      ...
      <p class="fs-7 text-muted">
        <a target="_blank" href="https://hathitrust.atlassian.net/servicedesk/customer/kb/view/2387345411">What affects the download speed?</a>
      </p>
      {:else}
