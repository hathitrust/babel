...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="list-surveys">
    <xsl:if test="true() or ( $gLoggedIn = 'YES' and $gHathiTrustAffiliate = 'true' )">
        ...
        <div class="beta--panel">
          <div class="alert">
            ...
            <p>
              ...
              <a href="#" style="color: black; font-size: 0.875rem">Learn more</a>
            </p>
          </div>
          <div>
