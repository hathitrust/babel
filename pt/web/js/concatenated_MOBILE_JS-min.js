...
/* /htapps/bkammin.babel/pt/web/mobile/epub_download_helper.js */
...
/* /htapps/bkammin.babel/pt/web/mobile/jquery.url.js */
/*!
 * jQuery UI 1.8.5
 *
...
b.dequeue()})})}})(jQuery);
;
/* /htapps/bkammin.babel/pt/web/mobile/jquery-ui-1.8.5.custom.min.js */
...
/* /htapps/bkammin.babel/pt/web/mobile/HTMobileBookReader.js */
/**
...
/* /htapps/bkammin.babel/pt/web/mobile/jquery.ui.ipad.js */
/*
	...
	$.fn.swipe = function(options) {
		...
		return this.each(function() {
			...
			function touchStart(event) {
				//console.log('Starting swipe gesture 1...')
			...
			function touchEnd(event) {
				...
				//console.log('Ending swipe gesture...' + $(me).attr('id'));
			...
			// Swipe was started
			function touchStart(event) {
				//console.log('Starting swipe gesture 2...')
				originalCoord.x = event.targetTouches[0].pageX
				originalCoord.y = event.targetTouches[0].pageY
...
/* /htapps/bkammin.babel/pt/web/mobile/jquery.jswipe-0.1.2.js */
