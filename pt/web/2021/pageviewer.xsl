...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="action-search-volume">
    ...
    <form class="form-inline form-search-volume {$class}" method="get" id="form-search-volume" role="search">
      ...
      <input type="hidden" name="sz" value="{/MBooksTop/MBooksGlobals/CurrentCgi/Param[@name='sz']}" />
      <input type="hidden" name="start" value="{/MBooksTop/MBooksGlobals/CurrentCgi/Param[@name='start']}" />
    </form>
  </xsl:template>
