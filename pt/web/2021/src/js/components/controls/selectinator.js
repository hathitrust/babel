...
export var Selectinator = class {
  ...
  setup() {
    ...
    for(var i = 0; i < pages.length; i++) {
      ...
      button.classList.add('action-toggle-selection', 'btn');
      ...
      button.setAttribute('tabindex', page.getAttribute('tabindex'));
    }
  }
  ...
  _addPageToSelection(page, input, evt, toggle) {
      ...
      if ( input._tippy ) {
        input._tippy.setContent(input.getAttribute('aria-label'));
      }
