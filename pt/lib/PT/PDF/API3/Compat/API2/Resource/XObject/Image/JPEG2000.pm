...
#
#   $Id: JPEG2000.pm,v 1.1 2010/03/04 20:34:09 pfarber Exp $
#
#=======================================================================
package PDF::API3::Compat::API2::Resource::XObject::Image::JPEG2000;
...
BEGIN {
    ...
    ( $VERSION ) = sprintf '%i.%03i', split(/\./,('$Revision: 1.1 $' =~ /Revision: (\S+)\s/)[0]); # $Date: 2010/03/04 20:34:09 $
...
sub new 
{
    ...
    if ( $info->{'Colorspace'} eq 'sRGB' ) {
        $self->colorspace('DeviceRGB')
    } elsif ( $info->{'Colorspace'} eq 'Grayscale' ) {
        $self->colorspace('DeviceGray')
    } else {
        print STDERR "Unknown colorspace: ", $info->{'Colorspace'}, "\n";
        $self->colorspace('DeviceRGB');
    }
...
=head1 HISTORY
    ...
    $Log: JPEG2000.pm,v $
    Revision 1.1  2010/03/04 20:34:09  pfarber
    Initial population of hacked API3 class hierarchy
