...
#
#   $Id: API2.pm,v 1.1 2010/03/04 20:34:09 pfarber Exp $
#
#=======================================================================
...
BEGIN {
    ...
    @FontDirs = ( (map { "$_/PT/PDF/API3/Compat/API2/fonts" } @INC), 
...
#     use PDF::API3::Compat::API2::Resource::XObject::Image::GD;
    use PDF::API3::Compat::API2::Resource::XObject::Image::JPEG2000;
...
sub image_jp2 {
    ...
    my $obj=PDF::API3::Compat::API2::Resource::XObject::Image::JPEG2000->new_api($self,$file);
