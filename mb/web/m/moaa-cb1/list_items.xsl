    ...
    <div class="ColSidebar">
      <div id="colBranding">
        <xsl:element name="img">
          <xsl:attribute name="src">/mb/m/moaa-cb1/graphics/MOAA.jpg</xsl:attribute>
      ...
      <div class="ownerLink">
        <xsl:element name="a">
          ...
          <xsl:attribute name="onClick">pageTracker._trackEvent('cbActions', 'click', 'CB-branded MOAA1 link');</xsl:attribute>
