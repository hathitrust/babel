...
sub run {
    ...
    my $processor = Process::Article::EPUB->new(
        mdpItem => $mdpItem,
...
sub _fill_params {
    ...
    unless ( $cache_filename ) {
        $cache_filename = Identifier::id_to_mdp_path($id) . "__$marker" . ".epub";
    }
