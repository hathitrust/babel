...
CREATE TABLE `access_stmts` (`stmt_key` varchar(32) NOT NULL default '', `stmt_url` text NOT NULL default '', `stmt_head` text NOT NULL default '', `stmt_icon` text NOT NULL default '', `stmt_text` text NOT NULL default '', PRIMARY KEY (`stmt_key`));
...
INSERT INTO access_stmts
       SET
       stmt_key='cc-by',
       stmt_url='http://creativecommons.org/licenses/by/3.0/us/',
       stmt_head='Creative Commons Attribution',
       stmt_icon='http://i.creativecommons.org/l/by/3.0/us/80x15.png',
...
INSERT INTO access_stmts
       SET
       stmt_key='cc-by-nd',
       stmt_url='http://creativecommons.org/licenses/by-nd/3.0/us/',
       stmt_head='Creative Commons Attribution-NoDerivatives',
       stmt_icon='http://i.creativecommons.org/l/by-nd/3.0/us/80x15.png',
...
INSERT INTO access_stmts
       ...
       stmt_url='http://creativecommons.org/licenses/by-nc-nd/3.0/us/',
       stmt_head='Creative Commons Attribution-NonCommercial-NoDerivatives',
       stmt_icon='http://i.creativecommons.org/l/by-nc-nd/3.0/us/80x15.png',
...
INSERT INTO access_stmts
       SET
       stmt_key='cc-by-nc',
       stmt_url='http://creativecommons.org/licenses/by-nc/3.0/us/',
       stmt_head='Creative Commons Attribution-NonCommercial',
       stmt_icon='http://i.creativecommons.org/l/by-nc/3.0/us/80x15.png',
...
INSERT INTO access_stmts
       ...
       stmt_url='http://creativecommons.org/licenses/by-nc-sa/3.0/us/',
       stmt_head='Creative Commons Attribution-NonCommercial-ShareAlike',
       stmt_icon='http://i.creativecommons.org/l/by-nc-sa/3.0/us/80x15.png',
...
INSERT INTO access_stmts
       SET
       stmt_key='cc-by-sa',
       stmt_url='http://creativecommons.org/licenses/by-sa/3.0/us/',
       stmt_head='Creative Commons Attribution-ShareAlike',
       stmt_icon='http://i.creativecommons.org/l/by-sa/3.0/us/80x15.png',
